...
用于在全新 Ubuntu 24.04 VPS 上自动部署 Xray VLESS + Reality 节点，并生成 Clash/Mihomo YAML 订阅。

## 目录

- `scripts/deploy.sh`：一键安装 Xray、Nginx、防火墙规则并生成订阅。
...
脚本完成后会输出 Clash/Mihomo 订阅地址。将地址导入 Clash Verge 的 Profiles 即可。
